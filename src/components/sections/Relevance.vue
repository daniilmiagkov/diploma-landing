...
const faqs: QA[] = [
  ...
  },
  {
    ...
    answer:
      'Цветные изображения и карты глубины, получаемые с помощью стереокамеры ZED2i. Глубина позволяет переводить пиксели в миллиметры для точного учёта фракций.',
  },
  {
    id: 'vs-manual',
